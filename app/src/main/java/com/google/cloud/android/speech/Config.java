...
public enum Config {
    ...
    public static String checkEnglishQuestion= hostUrl + "/restservice/api/questionsservice/getenglishquestion";
    public static String checkSinhalaQuestion = hostUrl + "/restservice/api/questionsservice/getsinhalaquestion";
    public static String checkTamilQuestion = hostUrl + "/restservice/api/questionsservice/gettamilquestion";
